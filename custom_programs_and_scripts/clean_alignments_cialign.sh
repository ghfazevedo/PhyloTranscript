...
Start CIAlign:
CIAlign --remove_divergent --remove_divergent_minperc '$min_diver' --remove_insertions --insertion_min_perc '$min_insertion' --crop_ends --remove_short --remove_min_length '$min_length' --visualise
...
for file in $file_list
    do
      ...
      sem --id cleaning --jobs $n_jobs CIAlign --infile $input_folder/$file --outfile_stem $output_folder/$file --remove_divergent --remove_divergent_minperc $min_diver --remove_insertions --insertion_min_perc $min_insertion --crop_ends --remove_short --remove_min_length $min_length --visualise
    done	  
